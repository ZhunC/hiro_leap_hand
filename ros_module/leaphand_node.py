...
class LeapNode:
    ...
    def __init__(self):
        ...
        print(f'Current pose is {self.curr_pos}')
    ...
    def _stretch_sense_set(self, pose):
        print(f'Joint states received: {pose.position}')
        ...
        pose_inc = [
            ...
            input[-1],
            input[-1],
            input[-1],  # pinky finger
            0,
            0,
            input[1],
            input[1]  # thumb
        ]
        pose_base = [3.14,    3.14159, 3.14159, 1.57,    3.14,    3.14159, 3.14159, 3.14159, 3.14,
            1.57,    3.14159, 3.14159, 4.69,    1.57,    3.14159, 3.14159]
        pose = [-x + y for x, y in zip(pose_inc, pose_base)]
        self.prev_pos = self.curr_pos
        self.curr_pos = np.array(pose)
        self.dxl_client.write_desired_pos(self.motors, self.curr_pos)
